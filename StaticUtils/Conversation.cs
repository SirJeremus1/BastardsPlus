...
namespace BastardsPlus.StaticUtils
{
    public static class Conversation
    {
        ...
        public static bool BastardConceptionAllowed()
        {
            ...
            if (!Utils.HerosRelated(Hero.MainHero, otherHero)) return false;
        ...
        public static void ConceiveBastard()
        {
            ...
            {
                // Conception chance
                if (Utils.PercentChanceCheck(30))
                {
            ...
            heroesAskedForConception[otherHero] = CampaignTime.DaysFromNow(1);
