...
namespace BastardsPlus.Models
{
    public class Bastard
    {
        ...
        public Bastard(Hero heroFather, Hero heroMother)
        {
            ...
            double minYears = 0.01;
            double maxYears = 0.05;
        ...
        private void SetBastardGuardian(Hero guardian, Hero? guardianSpouse = null, Hero? consequenceHero = null)
        {
            ...
            if (guardianClan != null)
            {
                ...
                if (guardianSpouse != null)
                {
                    ...
                    if (guardian.IsFemale && Utils.PercentChanceCheck(50))
                    {
                        KeptSecret(guardian);
                        return;
                    }
        ...
        private void DoConsequence(Hero guardian, Hero? guardianSpouse, Hero consequenceHero)
        {
            ...
            Utils.ModifyHeroRelations(consequenceHero, guardianSpouse, 1);
            if (guardian.Clan.Leader == guardian) return;

            Utils.ModifyHeroRelations(consequenceHero, guardian.Clan.Leader, 1);
        }
        ...
        public void Birth()
        {
            ...
            // Stillbirth chance
            if (Utils.PercentChanceCheck(10))
            {
